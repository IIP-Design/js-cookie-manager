...
class JS_Cookie_Manager {
	...
	function iip_enqueue_scripts() {
		wp_register_script('js-cookie-manager', plugin_dir_url( __FILE__ ) . 'js/dist/js-cookie-manager.min.js', array(),  '1.1.0', true );

		wp_enqueue_script( 'js-cookie-manager');
		wp_enqueue_script( 'lang-cookie-listener', plugin_dir_url( __FILE__ ) . 'js/dist/lang-cookie-listener.min.js', array('jquery', 'js-cookie-manager'), '1.1.0', true );
	}
}
